...
import VariationPrice from '@components/product/product-details/product-variant-price';
  ...
  return (
    <article className="bg-light w-full max-w-6xl xl:min-w-[1152px] relative z-[51]">
      ...
      <div className="flex flex-col md:flex-row border-b border-border-200 border-opacity-70">
        <div className="md:w-1/2 md:max-w-[600px] p-5 pt-10 md:p-10 md:pr-5 lg:p-14 lg:pr-7 xl:p-16 xl:pr-8">
