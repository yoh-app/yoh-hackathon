...
import { AuthProvider as MagicProvider } from 'admin/src/magic/components/AuthProvider';
import { AuthProvider as SessionProvider } from '@contexts/session.context';
import { ModalContextProvider } from 'admin/src/magic/components/Modal';
import complete from 'admin/src/magic/api/complete';
import 'admin/src/magic/styles/globals.css';
...
import BlockchainWrapper from 'admin/src/components/BlockchainWrapper';
          ...
          <SessionProvider>
            <BlockchainWrapper chainData={pageProps?.website?.chain}>
              <QueryClientProvider client={queryClientRef.current}>
                <SettingsProvider initialValue={pageProps?.website}>
                  <CustomerProvider>
                    <ModalProvider>
                      <CartProvider>
                        <UIProvider>
